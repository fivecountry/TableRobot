    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            for (int kk = 0; kk < 30; kk++)
            {
                ...
                item1.DisplayText = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" + kk;
                item1.Height = 50;
                this.timeLineControl1.Items.Add(item1);
            }
        }

        private void timeLineControl1_SelectedChanged(object sender, TimeLineSelectedChangedEventArgs args)
        {
            Text = args.Selected.DisplayText;
        }
    }
}