...
namespace Win32
{
	...
	public abstract class GDI
	{
		...
		[DllImport("gdi32")] public static extern int EnumFontFamilies(HDC hdc, StringBuilder lpszFamily, ref int lpEnumFontFamProc, int lParam);
		...
		[DllImport("gdi32")] public static extern int EnumFonts(HWND hdc, StringBuilder lpsz, ref int lpFontEnumProc, int lParam);
		...
		[DllImport("gdi32")] public static extern int ExtTextOut(HDC hdc, int x, int y, int wOptions, ref RECT lpRect, StringBuilder lpString, int nCount, ref int lpDx);
		...
		[DllImport("gdi32")] public static extern int GetTextExtentExPoint(HDC hdc, StringBuilder lpszStr, int cchString, int nMaxExtent, ref int lpnFit, int alpDx, ref SIZE lpSize);
