...
namespace Win32
{
	...
	public abstract class GDI
	{
		...
		[DllImport("gdi32")] public static extern int CopyEnhMetaFile(HANDLE hemfSrc, StringBuilder lpszFile);
		[DllImport("gdi32")] public static extern int CopyMetaFile(HANDLE hMF, StringBuilder lpFileName);
		...
		[DllImport("gdi32")] public static extern int CreateEnhMetaFile(HWND hdcRef, StringBuilder lpFileName, ref RECT lpRect, StringBuilder lpDescription);
		[DllImport("gdi32")] public static extern int CreateFont(HANDLE h, int W, int E, int O, int W2, int I, int u, int S, int C, int OP, int CP, int Q, int PAF, StringBuilder F);
		...
		[DllImport("gdi32")] public static extern int CreatePolyPolygonRgn(ref POINT lpPoint, IntPtr  lpPolyCounts, int nCount, int nPolyFillMode);
		...
		[DllImport("gdi32")] public static extern int CreateScalableFontResource(int fHidden, StringBuilder lpszResourceFile, StringBuilder lpszFontFile, StringBuilder lpszCurrentPath);
		...
		[DllImport("gdi32")] public static extern int DrawEscape(HDC hdc, int nEscape, int cbInput, StringBuilder lpszInData);
		...
		[DllImport("gdi32")] public static extern int EnumEnhMetaFile(HDC hdc, HANDLE hemf, IntPtr  lpEnhMetaFunc, IntPtr lpData, ref RECT lpRect);
		[DllImport("gdi32")] public static extern int EnumFontFamilies(HDC hdc, StringBuilder lpszFamily, IntPtr  lpEnumFontFamProc, int lParam);
		[DllImport("gdi32")] public static extern int EnumFontFamiliesEx(HDC hdc, ref LOGFONT lpLogFont, IntPtr  lpEnumFontProc, int lParam, int dw);
		[DllImport("gdi32")] public static extern int EnumFonts(HWND hdc, StringBuilder lpsz, IntPtr  lpFontEnumProc, int lParam);
		[DllImport("gdi32")] public static extern int EnumICMProfiles(HDC hdc, int icmEnumProc, int lParam);
		[DllImport("gdi32")] public static extern int EnumMetaFile(HWND hdc, HANDLE hMetafile, IntPtr  lpMFEnumProc, int lParam);
		[DllImport("gdi32")] public static extern int EnumObjects(HWND hdc, int n, IntPtr  lpGOBJEnumProc, IntPtr lpVoid);
		[DllImport("gdi32")] public static extern int EqualRgn(HANDLE hSrcRgn1, HANDLE hSrcRgn2);
		[DllImport("gdi32")] public static extern int Escape(HDC hdc, int nEscape, int nCount, StringBuilder lpInData, IntPtr lpOutData);
		...
		[DllImport("gdi32")] public static extern int ExtEscape(HDC hdc, int nEscape, int cbInput, StringBuilder lpszInData, int cbOutput, StringBuilder lpszOutData);
		...
		[DllImport("gdi32")] public static extern int ExtTextOut(HDC hdc, int x, int y, int wOptions, ref RECT lpRect, StringBuilder lpString, int nCount, IntPtr  lpDx);
		...
		[DllImport("gdi32")] public static extern int GetCharacterPlacement(HDC hdc, StringBuilder lpsz, int n1, int n2, ref GCP_RESULTS lpGcpResults, int dw);
		...
		[DllImport("gdi32")] public static extern int GetICMProfile(HDC hdc, int dw, StringBuilder lpStr);
		...
		[DllImport("gdi32")] public static extern int GetTextExtentExPoint(HDC hdc, StringBuilder lpszStr, int cchString, int nMaxExtent, IntPtr  lpnFit, int alpDx, ref SIZE lpSize);
		[DllImport("gdi32")] public static extern int GetTextExtentPoint(HDC hdc, StringBuilder lpszString, int cbString, ref SIZE lpSize);
		[DllImport("gdi32")] public static extern int GetTextExtentPoint32(HDC hdc, StringBuilder lpsz, int cbString, ref SIZE lpSize);
		[DllImport("gdi32")] public static extern int GetTextFace(HDC hdc, int nCount, StringBuilder lpFacename);
		...
		[DllImport("gdi32")] public static extern int LineDDA(int n1, int n2, int n3, int n4, IntPtr  lpLineDDAProc, int lParam);
		...
		[DllImport("gdi32")] public static extern int PolyPolygon(HDC hdc, ref POINT lpPoint, IntPtr  lpPolyCounts, int nCount);
		[DllImport("gdi32")] public static extern int PolyPolyline(HDC hdc, ref POINT lppt, IntPtr  lpdwPolyPoints, int cCount);
		...
		[DllImport("gdi32")] public static extern int SetAbortProc(HWND hdc, IntPtr  lpAbortProc);
		...
		[DllImport("gdi32")] public static extern int SetICMProfile(HDC hdc, StringBuilder lpStr);
		...
		[DllImport("gdi32")] public static extern int TextOut(HDC hdc, int x, int y, StringBuilder lpString, int nCount);
