...
namespace Win32
{
	...
	public class User
	{
		...
		[DllImport("user32")] public static extern int CharToOem(string lpszSrc, StringBuilder lpszDst);
		[DllImport("user32")] public static extern int CharToOemBuff(string lpszSrc, StringBuilder lpszDst, int cchDstLength);
		...
		[DllImport("user32")] public static extern int CreateDesktop(string lpszDesktop, StringBuilder lpszDevice, ref DEVMODE pDevmode, int dwFlags, int dwDesiredAccess, ref SECURITY_ATTRIBUTES lpsa);
		...
		[DllImport("user32")] public static extern int CreateMDIWindow(string lpClassName, StringBuilder lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, HWND hwndParent, HANDLE hInstance, int lParam);
		...
		[DllImport("user32")] public static extern int FindWindow(string lpClassName, StringBuilder lpWindowName);
		...
		[DllImport("user32")] public static extern int OemToChar(string lpszSrc, StringBuilder lpszDst);
		[DllImport("user32")] public static extern int OemToCharBuff(string lpszSrc, StringBuilder lpszDst, int cchDstLength);
		...
		[DllImport("user32")] public static extern string CharPrev(string lpszStart, StringBuilder lpszCurrent);
