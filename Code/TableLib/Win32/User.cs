...
namespace Win32
{
	...
	public class User
	{
		...
		[DllImport("mpr")] public static extern int WNetGetUniversalName(StringBuilder lpLocalPath, int dwInfoLevel, StringBuilder lpBuffer, ref int lpBufferSize);
		...
		[DllImport("user32")] public static extern int CreateDialogParam(HANDLE hInstance, StringBuilder lpName, HWND hwndParent, ref int lpDialogFunc, int lParamInit);
		...
		[DllImport("user32")] public static extern int GetTabbedTextExtent(HDC hdc, StringBuilder lpString, int nCount, int nTabPositions, ref int lpnTabStopPositions);
		...
		[DllImport("user32")] public static extern int TabbedTextOut(HDC hdc, int x, int y, StringBuilder lpString, int nCount, int nTabPositions, ref int lpnTabStopPositions, int nTabOrigin);
