...
namespace Win32
{
	...
	public class User
	{
		...
		[DllImport("mpr")] public static extern int WNetGetUniversalName(StringBuilder lpLocalPath, int dwInfoLevel, StringBuilder lpBuffer, IntPtr  lpBufferSize);
		...
		[DllImport("user32")] public static extern int BroadcastSystemMessage(int dw, IntPtr  pdw, int un, int wParam, int lParam);
		...
		[DllImport("user32")] public static extern int ChangeMenu(HANDLE hMenu, int cmd, StringBuilder lpszNewItem, int cmdInsert, int flags);
		[DllImport("user32")] public static extern int CharLowerBuff(StringBuilder lpsz, int cchLength);
		[DllImport("user32")] public static extern int CharToOem(StringBuilder lpszSrc, StringBuilder lpszDst);
		[DllImport("user32")] public static extern int CharToOemBuff(StringBuilder lpszSrc, StringBuilder lpszDst, int cchDstLength);
		[DllImport("user32")] public static extern int CharUpperBuff(StringBuilder lpsz, int cchLength);
		...
		[DllImport("user32")] public static extern int CreateDesktop(StringBuilder lpszDesktop, StringBuilder lpszDevice, ref DEVMODE pDevmode, int dwFlags, int dwDesiredAccess, ref SECURITY_ATTRIBUTES lpsa);
		[DllImport("user32")] public static extern int CreateDialogIndirectParam(HANDLE hInstance, ref DLGTEMPLATE lpTemplate, HWND hwndParent, IntPtr  lpDialogFunc, int dwInitParam);
		[DllImport("user32")] public static extern int CreateDialogParam(HANDLE hInstance, StringBuilder lpName, HWND hwndParent, IntPtr  lpDialogFunc, int lParamInit);
		...
		[DllImport("user32")] public static extern int CreateMDIWindow(StringBuilder lpClassName, StringBuilder lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, HWND hwndParent, HANDLE hInstance, int lParam);
		[DllImport("user32")] public static extern int CreateMenu();
		[DllImport("user32")] public static extern int CreatePopupMenu();
		[DllImport("user32")] public static extern int CreateWindowEx(int dwExStyle, StringBuilder lpClassName, StringBuilder lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, HWND hwndParent, HANDLE hMenu, HANDLE hInstance, IntPtr lpParam);
		[DllImport("user32")] public static extern int DdeAbandonTransaction(int idInst, HANDLE hConv, int idTransaction);
		[DllImport("user32")] public static extern int DdeAccessData(HANDLE hData, IntPtr  pcbDataSize);
		[DllImport("user32")] public static extern int DdeAddData(HANDLE hData, Byte pSrc, int cb, int cbOff);
		[DllImport("user32")] public static extern int DdeClientTransaction(Byte pData, int cbData, HANDLE hConv, HANDLE hszItem, int wFmt, int wType, int dwTimeout, IntPtr  pdwResult);
		...
		[DllImport("user32")] public static extern int DdeCreateStringHandle(int idInst, StringBuilder psz, int iCodePage);
		...
		[DllImport("user32")] public static extern int DdeQueryString(int idInst, HANDLE hsz, StringBuilder psz, int cchMax, int iCodePage);
		...
		[DllImport("user32")] public static extern int DialogBoxIndirectParam(HANDLE hInstance, DLGTEMPLATE hDialogTemplate, HWND hwndParent, IntPtr  lpDialogFunc, int dwInitParam);
		[DllImport("user32")] public static extern int DispatchMessage(ref MSG lpMsg);
		[DllImport("user32")] public static extern int DlgDirList(HANDLE hDlg, StringBuilder lpPathSpec, int nIDListBox, int nIDStaticPath, int wFileType);
		[DllImport("user32")] public static extern int DlgDirListComboBox(HANDLE hDlg, StringBuilder lpPathSpec, int nIDComboBox, int nIDStaticPath, int wFileType);
		[DllImport("user32")] public static extern int DlgDirSelectComboBoxEx(HWND hwndDlg, StringBuilder lpszPath, int cbPath, int idComboBox);
		[DllImport("user32")] public static extern int DlgDirSelectEx(HWND hwndDlg, StringBuilder lpszPath, int cbPath, int idListBox);
		...
		[DllImport("user32")] public static extern int DrawState(HWND hdc, HANDLE hBrush, IntPtr  lpDrawStateProc, int lParam, int wParam, int n1, int n2, int n3, int n4, int un);
		[DllImport("user32")] public static extern int DrawText(HDC hdc, StringBuilder lpStr, int nCount, ref RECT lpRect, int wFormat);
		[DllImport("user32")] public static extern int DrawTextEx(HWND hdc, StringBuilder lpsz, int n, ref RECT lpRect, int un, ref DRAWTEXTPARAMS lpDrawTextParams);
		...
		[DllImport("user32")] public static extern int EnumChildWindows(HWND hwndParent, IntPtr  lpEnumFunc, int lParam);
		[DllImport("user32")] public static extern int EnumClipboardFormats(int wFormat);
		[DllImport("user32")] public static extern int EnumDesktopWindows(HANDLE hDesktop, IntPtr  lpfn, int lParam);
		[DllImport("user32")] public static extern int EnumDesktops(HANDLE hwinsta, IntPtr  lpEnumFunc, int lParam);
		[DllImport("user32")] public static extern int EnumProps(HWND hwnd, IntPtr  lpEnumFunc);
		[DllImport("user32")] public static extern int EnumPropsEx(HWND hwnd, IntPtr  lpEnumFunc, int lParam);
		[DllImport("user32")] public static extern int EnumThreadWindows(int dwThreadId, IntPtr  lpfn, int lParam);
		...
		[DllImport("user32")] public static extern int FindWindow(StringBuilder lpClassName, StringBuilder lpWindowName);
		[DllImport("user32")] public static extern int FindWindowEx(HWND hwnd1, HWND hwnd2, StringBuilder lpsz1, StringBuilder lpsz2);
		...
		[DllImport("user32")] public static extern int GetClassInfo(HANDLE hInstance, StringBuilder lpClassName, out WNDCLASS lpWndClass);
		...
		[DllImport("user32")] public static extern int GetClipboardFormatName(int wFormat, StringBuilder lpString, int nMaxCount);
		...
		[DllImport("user32")] public static extern int GetDlgItemInt(HANDLE hDlg, int nIDDlgItem, IntPtr  lpTranslated, int bSigned);
		...
		[DllImport("user32")] public static extern int GetKeyboardLayoutList(int nBuff, IntPtr  lpList);
		[DllImport("user32")] public static extern int GetKeyboardLayoutName(StringBuilder pwszKLID);
		...
		[DllImport("user32")] public static extern int GetProp(HWND hwnd, StringBuilder lpString);
		...
		[DllImport("user32")] public static extern int GetScrollRange(HWND hwnd, int nBar, IntPtr  lpMinPos, IntPtr  lpMaxPos);
		...
		[DllImport("user32")] public static extern int GetTabbedTextExtent(HDC hdc, StringBuilder lpString, int nCount, int nTabPositions, IntPtr  lpnTabStopPositions);
		...
		[DllImport("user32")] public static extern int GetUserObjectInformation(HANDLE hObj, int nIndex, IntPtr pvInfo, int nLength, IntPtr  lpnLengthNeeded);
		[DllImport("user32")] public static extern int GetUserObjectSecurity(HANDLE hObj, IntPtr  pSIRequested, ref SECURITY_DESCRIPTOR pSd, int nLength, IntPtr  lpnLengthNeeded);
		...
		[DllImport("user32")] public static extern int GetWindowThreadProcessId(HWND hwnd, IntPtr  lpdwProcessId);
		[DllImport("user32")] public static extern int GrayString(HWND hdc, HANDLE hBrush, IntPtr  lpOutputFunc, IntPtr  lpData, int nCount, int X, int Y, int nWidth, int nHeight);
		...
		[DllImport("user32")] public static extern int LoadAccelerators(HANDLE hInstance, StringBuilder lpTableName);
		[DllImport("user32")] public static extern int LoadBitmap(HANDLE hInstance, StringBuilder lpBitmapName);
		[DllImport("user32")] public static extern int LoadCursor(HANDLE hInstance, StringBuilder lpCursorName);
		[DllImport("user32")] public static extern int LoadCursorFromFile(StringBuilder lpFileName);
		[DllImport("user32")] public static extern int LoadIcon(HANDLE hInstance, StringBuilder lpIconName);
		[DllImport("user32")] public static extern int LoadImage(HANDLE hInst, StringBuilder lpsz, int un1, int n1, int n2, int un2);
		[DllImport("user32")] public static extern int LoadKeyboardLayout(StringBuilder pwszKLID, int flags);
		[DllImport("user32")] public static extern int LoadMenu(HANDLE hInstance, StringBuilder lpString);
		[DllImport("user32")] public static extern int LoadMenuIndirect(int lpMenuTemplate);
		[DllImport("user32")] public static extern int LoadString(HANDLE hInstance, int wID, StringBuilder lpBuffer, int nBufferMax);
		...
		[DllImport("user32")] public static extern int MessageBox(HWND hwnd, StringBuilder lpText, StringBuilder lpCaption, int wType);
		[DllImport("user32")] public static extern int MessageBoxEx(HWND hwnd, StringBuilder lpText, StringBuilder lpCaption, int uType, int wLanguageId);
		...
		[DllImport("user32")] public static extern int MsgWaitForMultipleObjects(int nCount, IntPtr  pHandles, int fWaitAll, int dwMilliseconds, int dwWakeMask);
		[DllImport("user32")] public static extern int OemKeyScan(int wOemChar);
		[DllImport("user32")] public static extern int OemToChar(StringBuilder lpszSrc, StringBuilder lpszDst);
		[DllImport("user32")] public static extern int OemToCharBuff(StringBuilder lpszSrc, StringBuilder lpszDst, int cchDstLength);
		...
		[DllImport("user32")] public static extern int OpenDesktop(StringBuilder lpszDesktop, int dwFlags, int fInherit, int dwDesiredAccess);
		...
		[DllImport("user32")] public static extern int OpenWindowStation(StringBuilder lpszWinSta, int fInherit, int dwDesiredAccess);
		...
		[DllImport("user32")] public static extern int RegisterClipboardFormat(StringBuilder lpString);
		[DllImport("user32")] public static extern int RegisterHotKey(HWND hwnd, int id, int fsModifiers, int vk);
		[DllImport("user32")] public static extern int RegisterWindowMessage(StringBuilder lpString);
		...
		[DllImport("user32")] public static extern int RemoveProp(HWND hwnd, StringBuilder lpString);
		...
		[DllImport("user32")] public static extern int SendMessageCallback(HWND hwnd, int msg, int wParam, int lParam, IntPtr  lpResultCallBack, int dwData);
		[DllImport("user32")] public static extern int SendMessageTimeout(HWND hwnd, int msg, int wParam, int lParam, int fuFlags, int uTimeout, IntPtr  lpdwResult);
		...
		[DllImport("user32")] public static extern int SetDlgItemText(HANDLE hDlg, int nIDDlgItem, StringBuilder lpString);
		...
		[DllImport("user32")] public static extern int SetProp(HWND hwnd, StringBuilder lpString, HANDLE hData);
		...
		[DllImport("user32")] public static extern int SetSysColors(int nChanges, IntPtr  lpSysColor, IntPtr  lpColorValues);
		...
		[DllImport("user32")] public static extern int SetUserObjectSecurity(HANDLE hObj, IntPtr  pSIRequested, ref SECURITY_DESCRIPTOR pSd);
		...
		[DllImport("user32")] public static extern int SetWindowText(HWND hwnd, StringBuilder lpString);
		[DllImport("user32")] public static extern int SetWindowWord(HWND hwnd, int nIndex, int wNewWord);
		[DllImport("user32")] public static extern int SetWindowsHook(int nFilterType, IntPtr  pfnFilterProc);
		...
		[DllImport("user32")] public static extern int TabbedTextOut(HDC hdc, int x, int y, StringBuilder lpString, int nCount, int nTabPositions, IntPtr  lpnTabStopPositions, int nTabOrigin);
		[DllImport("user32")] public static extern int ToAscii(int uVirtKey, int uScanCode, Byte lpbKeyState, IntPtr  lpwTransKey, int fuState);
		...
		[DllImport("user32")] public static extern int ToUnicode(int wVirtKey, int wScanCode, Byte lpKeyState, StringBuilder pwszBuff, int cchBuff, int wFlags);
		...
		[DllImport("user32")] public static extern int UnhookWindowsHook(int nCode, IntPtr  pfnFilterProc);
		...
		[DllImport("user32")] public static extern int UnpackDDElParam(int msg, int lParam, IntPtr  puiLo, IntPtr  puiHi);
		[DllImport("user32")] public static extern int UnregisterClass(StringBuilder lpClassName, HANDLE hInstance);
		...
		[DllImport("user32")] public static extern int WinHelp(HWND hwnd, StringBuilder lpHelpFile, int wCommand, int dwData);
		...
		[DllImport("user32")] public static extern short CascadeWindows(HWND hwndParent, int wHow, ref RECT lpRect, int cKids, IntPtr  lpkids);
		...
		[DllImport("user32")] public static extern short TileWindows(HWND hwndParent, int wHow, ref RECT lpRect, int cKids, IntPtr  lpKids);
		...
		[DllImport("user32")] public static extern string CharLower(StringBuilder lpsz);
		[DllImport("user32")] public static extern string CharNext(StringBuilder lpsz);
		[DllImport("user32")] public static extern string CharPrev(StringBuilder lpszStart, StringBuilder lpszCurrent);
		[DllImport("user32")] public static extern string CharUpper(StringBuilder lpsz);
