...
namespace Win32
{
	...
	public abstract class AdvApi
	{
		...
		[DllImport("advapi32")] public static extern int LogonUser(string lpszUsername, StringBuilder lpszDomain, StringBuilder lpszPassword, int dwLogonType, int dwLogonProvider, ref int phToken);
		...
		[DllImport("advapi32")] public static extern int InitiateSystemShutdown(string lpMachineName, StringBuilder lpMessage, int dwTimeout, int bForceAppsClosed, int bRebootAfterShutdown);
		...
		[DllImport("advapi32")] public static extern int LookupAccountName(string lpSystemName, StringBuilder lpAccountName, int Sid, int cbSid, StringBuilder ReferencedDomainName, int cbReferencedDomainName, int peUse);
		[DllImport("advapi32")] public static extern int LookupAccountSid(string lpSystemName, IntPtr Sid, StringBuilder name, int cbName, StringBuilder ReferencedDomainName, int cbReferencedDomainName, int peUse);
		[DllImport("advapi32")] public static extern int LookupPrivilegeDisplayName(string lpSystemName, StringBuilder lpName, StringBuilder lpDisplayName, int cbDisplayName, ref int lpLanguageID);
		[DllImport("advapi32")] public static extern int LookupPrivilegeName(string lpSystemName, ref LARGE_INTEGER lpLuid, StringBuilder lpName, int cbName);
		[DllImport("advapi32")] public static extern int LookupPrivilegeValue(string lpSystemName, StringBuilder lpName, ref LARGE_INTEGER lpLuid);
		...
		[DllImport("advapi32")] public static extern int OpenBackupEventLog(string lpUNCServerName, StringBuilder lpFileName);
		[DllImport("advapi32")] public static extern int OpenEventLog(string lpUNCServerName, StringBuilder lpSourceName);
		[DllImport("advapi32")] public static extern int OpenSCManager(string lpMachineName, StringBuilder lpDatabaseName, int dwDesiredAccess);
		...
		[DllImport("advapi32")] public static extern int PrivilegedServiceAuditAlarm(string SubsystemName, StringBuilder ServiceName, int ClientToken, PRIVILEGE_SET Privileges, int AccessGranted);
		...
		[DllImport("advapi32")] public static extern int RegisterEventSource(string lpUNCServerName, StringBuilder lpSourceName);
	...
	public abstract class Kernel
	{
		...
		[DllImport("kernel32")] public static extern int CopyFile(string lpExistingFileName, StringBuilder lpNewFileName, int bFailIfExists);
		...
		[DllImport("kernel32")] public static extern int CreateDirectoryEx(string lpTemplateDirectory, StringBuilder lpNewDirectory, ref SECURITY_ATTRIBUTES lpSecurityAttributes);
		...
		[DllImport("kernel32")] public static extern int CreateProcess(string lpApplicationName, StringBuilder lpCommandLine, ref SECURITY_ATTRIBUTES lpProcessAttributes, ref SECURITY_ATTRIBUTES lpThreadAttributes, int bInheritHandles, int dwCreationFlags, IntPtr lpEnvironment, StringBuilder lpCurrentDriectory, ref STARTUPINFO lpStartupInfo, ref PROCESS_INFORMATION lpProcessInformation);
		...
		[DllImport("kernel32")] public static extern int ExpandEnvironmentStrings(string lpSrc, StringBuilder lpDst, int nSize);
		...
		[DllImport("kernel32")] public static extern int GetEnvironmentVariable(string lpName, StringBuilder lpBuffer, int nSize);
		...
		[DllImport("kernel32")] public static extern int GetFullPathName(string lpFileName, int nBufferLength, StringBuilder lpBuffer, StringBuilder lpFilePart);
		...
		[DllImport("kernel32")] public static extern int GetPrivateProfileInt(string lpApplicationName, StringBuilder lpKeyName, int nDefault, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int GetPrivateProfileSection(string lpAppName, StringBuilder lpReturnedString, int nSize, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int GetPrivateProfileString(string lpApplicationName, IntPtr lpKeyName, StringBuilder lpDefault, StringBuilder lpReturnedString, int nSize, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int GetPrivateProfileString(string lpApplicationName, StringBuilder lpKeyName, StringBuilder lpDefault, StringBuilder lpReturnedString, int nSize, StringBuilder lpFileName);
		...
		[DllImport("kernel32")] public static extern int GetProfileInt(string lpAppName, StringBuilder lpKeyName, int nDefault);
		[DllImport("kernel32")] public static extern int GetProfileSection(string lpAppName, StringBuilder lpReturnedString, int nSize);
		[DllImport("kernel32")] public static extern int GetProfileString(string lpAppName, StringBuilder lpKeyName, StringBuilder lpDefault, StringBuilder lpReturnedString, int nSize);
		...
		[DllImport("kernel32")] public static extern int GetShortPathName(string lpszLongPath, StringBuilder lpszShortPath, int cchBuffer);
		...
		[DllImport("kernel32")] public static extern int GetTempFileName(string lpszPath, StringBuilder lpPrefixString, int wUnique, StringBuilder lpTempFileName);
		...
		[DllImport("kernel32")] public static extern int GetVolumeInformation(string lpRootPathName, StringBuilder lpVolumeNameBuffer, int nVolumeNameSize, ref int lpVolumeSerialNumber, ref int lpMaximumComponentLength, ref int lpFileSystemFlags, StringBuilder lpFileSystemNameBuffer, int nFileSystemNameSize);
		...
		[DllImport("kernel32")] public static extern int MoveFile(string lpExistingFileName, StringBuilder lpNewFileName);
		[DllImport("kernel32")] public static extern int MoveFileEx(string lpExistingFileName, StringBuilder lpNewFileName, int dwFlags);
		...
		[DllImport("kernel32")] public static extern int QueryDosDevice(string lpDeviceName, StringBuilder lpTargetPath, int ucchMax);
		...
		[DllImport("kernel32")] public static extern int SearchPath(string lpPath, StringBuilder lpFileName, StringBuilder lpExtension, int nBufferLength, StringBuilder lpBuffer, StringBuilder lpFilePart);
		...
		[DllImport("kernel32")] public static extern int SetEnvironmentVariable(string lpName, StringBuilder lpValue);
		...
		[DllImport("kernel32")] public static extern int SetVolumeLabel(string lpRootPathName, StringBuilder lpVolumeName);
		...
		[DllImport("kernel32")] public static extern int WritePrivateProfileSection(string lpAppName, StringBuilder lpString, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int WritePrivateProfileString(string lpApplicationName, IntPtr lpKeyName, IntPtr lpString, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int WritePrivateProfileString(string lpApplicationName, StringBuilder lpKeyName, IntPtr lpString, StringBuilder lpFileName);
		...
		[DllImport("kernel32")] public static extern int WriteProfileSection(string lpAppName, StringBuilder lpString);
		[DllImport("kernel32")] public static extern int WriteProfileString(string lpszSection, StringBuilder lpszKeyName, StringBuilder lpszString);
		...
		[DllImport("kernel32")] public static extern int lstrcat(string lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcmp(string lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcmpi(string lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcpy(string lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcpyn(string lpString1, StringBuilder lpString2, int iMaxLength);
