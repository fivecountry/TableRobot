...
namespace Win32
{
	...
	public abstract class AdvApi
	{
		...
		[DllImport("advapi32")] public static extern int LogonUser(StringBuilder lpszUsername, StringBuilder lpszDomain, StringBuilder lpszPassword, int dwLogonType, int dwLogonProvider, ref int phToken);
		...
		[DllImport("advapi32")] public static extern int ChangeServiceConfig(HANDLE hService, int dwServiceType, int dwStartType, int dwErrorControl, StringBuilder lpBinaryPathName, StringBuilder lpLoadOrderGroup, ref int lpdwTagId, StringBuilder lpDependencies, StringBuilder lpServiceStartName, StringBuilder lpPassword, StringBuilder lpDisplayName);
		...
		[DllImport("advapi32")] public static extern int CreateService(HANDLE hSCManager, StringBuilder lpServiceName, StringBuilder lpDisplayName, int dwDesiredAccess, int dwServiceType, int dwStartType, int dwErrorControl, StringBuilder lpBinaryPathName, StringBuilder lpLoadOrderGroup, ref int lpdwTagId, StringBuilder lpDependencies, StringBuilder lp, StringBuilder lpPassword);
		...
		[DllImport("advapi32")] public static extern int GetFileSecurity(StringBuilder lpFileName, int RequestedInformation, ref SECURITY_DESCRIPTOR pSecurityDescriptor, int nLength, ref int lpnLengthNeeded);
		...
		[DllImport("advapi32")] public static extern int GetServiceDisplayName(HANDLE hSCManager, StringBuilder lpServiceName, StringBuilder lpDisplayName, ref int cchBuffer);
		[DllImport("advapi32")] public static extern int GetServiceKeyName(HANDLE hSCManager, StringBuilder lpDisplayName, StringBuilder lpServiceName, ref int cchBuffer);
		...
		[DllImport("advapi32")] public static extern int LookupPrivilegeDisplayName(StringBuilder lpSystemName, StringBuilder lpName, StringBuilder lpDisplayName, int cbDisplayName, ref int lpLanguageID);
		...
		[DllImport("advapi32")] public static extern int RegConnectRegistry(StringBuilder lpMachineName, HANDLE hKey, ref int phkResult);
		[DllImport("advapi32")] public static extern int RegCreateKey(HANDLE hKey, StringBuilder lpSubKey, ref int phkResult);
		[DllImport("advapi32")] public static extern int RegCreateKeyEx(HANDLE hKey, StringBuilder lpSubKey, int Reserved, StringBuilder lpClass, int dwOptions, int samDesired, ref SECURITY_ATTRIBUTES lpSecurityAttributes, ref int phkResult, ref int lpdwDisposition);
		...
		[DllImport("advapi32")] public static extern int RegEnumKeyEx(HANDLE hKey, int dwIndex, StringBuilder lpName, ref int lpcbName, ref int lpReserved, StringBuilder lpClass, ref int lpcbClass, ref FILETIME lpftLastWriteTime);
		[DllImport("advapi32")] public static extern int RegEnumValue(HANDLE hKey, int dwIndex, StringBuilder lpValueName, ref int lpcbValueName, ref int lpReserved, ref int lpType, Byte lpData, ref int lpcbData);
		...
		[DllImport("advapi32")] public static extern int RegOpenKey(HANDLE hKey, StringBuilder lpSubKey, ref int phkResult);
		[DllImport("advapi32")] public static extern int RegOpenKeyEx(HANDLE hKey, StringBuilder lpSubKey, int ulOptions, int samDesired, ref int phkResult);
		[DllImport("advapi32")] public static extern int RegQueryInfoKey(HANDLE hKey, StringBuilder lpClass, ref int lpcbClass, ref int lpReserved, ref int lpcSubKeys, ref int lpcbMaxSubKeyLen, ref int lpcbMaxClassLen, ref int lpcValues, ref int lpcbMaxValueNameLen, ref int lpcbMaxValueLen, ref int lpcbSecurityDescriptor, ref FILETIME lpftLastWriteTime);
		[DllImport("advapi32")] public static extern int RegQueryValue(HANDLE hKey, StringBuilder lpSubKey, StringBuilder lpValue, ref int lpcbValue);
		[DllImport("advapi32")] public static extern int RegQueryValueEx(HANDLE hKey, StringBuilder lpValueName, ref int lpReserved, ref int lpType, IntPtr lpData, ref int lpcbData); 
		...
		[DllImport("advapi32")] public static extern int RegisterServiceCtrlHandler(StringBuilder lpServiceName, ref int lpHandlerProc);
	...
	public abstract class Version
	{
		...
		[DllImport("version")] public static extern int GetFileVersionInfoSize(StringBuilder lptstrFilename, ref int lpdwHandle);
		[DllImport("version")] public static extern int VerFindFile(int uFlags, StringBuilder szFileName, StringBuilder szWinDir, StringBuilder szAppDir, StringBuilder szCurDir, ref int lpuCurDirLen, StringBuilder szDestDir, ref int lpuDestDirLen);
		[DllImport("version")] public static extern int VerInstallFile(int uFlags, StringBuilder szSrcFileName, StringBuilder szDestFileName, StringBuilder szSrcDir, StringBuilder szDestDir, StringBuilder szCurDir, StringBuilder szTmpFile, ref int lpuTmpFileLen);
		[DllImport("version")] public static extern int VerQueryValue(IntPtr pBlock, StringBuilder lpSubBlock, ref int lplpBuffer, ref int puLen);
	}
	...
	public abstract class Kernel
	{
		...
		[DllImport("kernel32")] public static extern int CallNamedPipe(StringBuilder lpNamedPipeName, IntPtr lpInBuffer, int nInBufferSize, IntPtr lpOutBuffer, int nOutBufferSize, ref int lpBytesRead, int nTimeOut);
		...
		[DllImport("kernel32")] public static extern int EnumResourceLanguages(HANDLE hModule, StringBuilder lpType, StringBuilder lpName, ref int lpEnumFunc, int lParam);
		[DllImport("kernel32")] public static extern int EnumResourceNames(HANDLE hModule, StringBuilder lpType, ref int lpEnumFunc, int lParam);
		...
		[DllImport("kernel32")] public static extern int GetBinaryType(StringBuilder lpApplicationName, ref int lpBinaryType);
		...
		[DllImport("kernel32")] public static extern int GetCompressedFileSize(StringBuilder lpFileName, ref int lpFileSizeHigh);
		...
		[DllImport("kernel32")] public static extern int GetDefaultCommConfig(StringBuilder lpszName, ref COMMCONFIG lpCC, ref int lpdwSize);
		[DllImport("kernel32")] public static extern int GetDiskFreeSpace(StringBuilder lpRootPathName, ref int lpSectorsPerCluster, ref int lpBytesPerSector, ref int lpNumberOfFreeClusters, ref int lpTotalNumberOfClusters);
		...
		[DllImport("kernel32")] public static extern int GetNamedPipeHandleState(HANDLE hNamedPipe, ref int lpState, ref int lpCurInstances, ref int lpMaxCollectionCount, ref int lpCollectDataTimeout, StringBuilder lpUserName, int nMaxUserNameSize);
		...
		[DllImport("kernel32")] public static extern int GetStringTypeA(int lcid, int dwInfoType, StringBuilder lpSrcStr, int cchSrc, ref int lpCharType);
		...
		[DllImport("kernel32")] public static extern int ReadConsoleOutputCharacter(HANDLE hConsoleOutput, StringBuilder lpCharacter, int nLength, COORD dwReadCoord, ref int lpNumberOfCharsRead);
		...
		[DllImport("kernel32")] public static extern int WideCharToMultiByte(int CodePage, int dwFlags, StringBuilder lpWideCharStr, int cchWideChar, StringBuilder lpMultiByteStr, int cchMultiByte, StringBuilder lpDefaultChar, ref int lpUsedDefaultChar);
		...
		[DllImport("kernel32")] public static extern int WriteConsoleOutputCharacter(HANDLE hConsoleOutput, StringBuilder lpCharacter, int nLength, COORD dwWriteCoord, ref int lpNumberOfCharsWritten);
