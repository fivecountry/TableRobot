...
namespace Win32
{
	...
	public abstract class AdvApi
	{
		...
		[DllImport("advapi32")] public static extern int IsTextUnicode(IntPtr lpBuffer, int cb, IntPtr  lpi);
		[DllImport("advapi32")] public static extern int LogonUser(StringBuilder lpszUsername, StringBuilder lpszDomain, StringBuilder lpszPassword, int dwLogonType, int dwLogonProvider, IntPtr  phToken);
		...
		[DllImport("advapi32")] public static extern int AbortSystemShutdown(StringBuilder lpMachineName);
		...
		[DllImport("advapi32")] public static extern int AccessCheckAndAuditAlarm(StringBuilder SubsystemName, IntPtr HandleId, StringBuilder ObjectTypeName, StringBuilder ObjectName, SECURITY_DESCRIPTOR SecurityDescriptor, int DesiredAccess, GENERIC_MAPPING GenericMapping, int ObjectCreation, int GrantedAccess, int AccessStatus, IntPtr  pfGenerateOnClose);
		...
		[DllImport("advapi32")] public static extern int AllocateAndInitializeSid(ref SID_IDENTIFIER_AUTHORITY pIdentifierAuthority, Byte nSubAuthorityCount, int nSubAuthority0, int nSubAuthority1, int nSubAuthority2, int nSubAuthority3, int nSubAuthority4, int nSubAuthority5, int nSubAuthority6, int nSubAuthority7, IntPtr  lpPSid);
		...
		[DllImport("advapi32")] public static extern int BackupEventLog(HANDLE hEventLog, StringBuilder lpBackupFileName);
		[DllImport("advapi32")] public static extern int ChangeServiceConfig(HANDLE hService, int dwServiceType, int dwStartType, int dwErrorControl, StringBuilder lpBinaryPathName, StringBuilder lpLoadOrderGroup, IntPtr  lpdwTagId, StringBuilder lpDependencies, StringBuilder lpServiceStartName, StringBuilder lpPassword, StringBuilder lpDisplayName);
		[DllImport("advapi32")] public static extern int ClearEventLog(HANDLE hEventLog, StringBuilder lpBackupFileName);
		...
		[DllImport("advapi32")] public static extern int CreateProcessAsUser(HANDLE hToken, StringBuilder lpApplicationName, StringBuilder lpCommandLine, ref SECURITY_ATTRIBUTES lpProcessAttributes, ref SECURITY_ATTRIBUTES lpThreadAttributes, int bInheritHandles, int dwCreationFlags, StringBuilder lpEnvironment, StringBuilder lpCurrentDirectory, ref STARTUPINFO lpStartupInfo, ref PROCESS_INFORMATION lpProcessInformation);
		[DllImport("advapi32")] public static extern int CreateService(HANDLE hSCManager, StringBuilder lpServiceName, StringBuilder lpDisplayName, int dwDesiredAccess, int dwServiceType, int dwStartType, int dwErrorControl, StringBuilder lpBinaryPathName, StringBuilder lpLoadOrderGroup, IntPtr  lpdwTagId, StringBuilder lpDependencies, StringBuilder lp, StringBuilder lpPassword);
		...
		[DllImport("advapi32")] public static extern int EnumDependentServices(HANDLE hService, int dwServiceState, ref ENUM_SERVICE_STATUS lpServices, int cbBufSize, IntPtr  pcbBytesNeeded, IntPtr  lpServicesReturned);
		[DllImport("advapi32")] public static extern int EnumServicesStatus(HANDLE hSCManager, int dwServiceType, int dwServiceState, ref ENUM_SERVICE_STATUS lpServices, int cbBufSize, IntPtr  pcbBytesNeeded, IntPtr  lpServicesReturned, IntPtr  lpResumeHandle);
		...
		[DllImport("advapi32")] public static extern int FindFirstFreeAce(ref ACL pAcl, IntPtr  pAce);
		...
		[DllImport("advapi32")] public static extern int GetFileSecurity(StringBuilder lpFileName, int RequestedInformation, ref SECURITY_DESCRIPTOR pSecurityDescriptor, int nLength, IntPtr  lpnLengthNeeded);
		[DllImport("advapi32")] public static extern int GetKernelObjectSecurity(HANDLE handle, int RequestedInformation, ref SECURITY_DESCRIPTOR pSecurityDescriptor, int nLength, IntPtr  lpnLengthNeeded);
		...
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorControl(ref SECURITY_DESCRIPTOR pSecurityDescriptor, short pControl, IntPtr  lpdwRevision);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorDacl(ref SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr  lpbDaclPresent, ref ACL pDacl, IntPtr  lpbDaclDefaulted);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorGroup(ref SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr pGroup, IntPtr  lpbGroupDefaulted);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorLength(ref SECURITY_DESCRIPTOR pSecurityDescriptor);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorOwner(ref SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr pOwner, IntPtr  lpbOwnerDefaulted);
		[DllImport("advapi32")] public static extern int GetSecurityDescriptorSacl(ref SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr  lpbSaclPresent, ref ACL pSacl, IntPtr  lpbSaclDefaulted);
		[DllImport("advapi32")] public static extern int GetServiceDisplayName(HANDLE hSCManager, StringBuilder lpServiceName, StringBuilder lpDisplayName, IntPtr  cchBuffer);
		[DllImport("advapi32")] public static extern int GetServiceKeyName(HANDLE hSCManager, StringBuilder lpDisplayName, StringBuilder lpServiceName, IntPtr  cchBuffer);
		...
		[DllImport("advapi32")] public static extern int InitiateSystemShutdown(StringBuilder lpMachineName, StringBuilder lpMessage, int dwTimeout, int bForceAppsClosed, int bRebootAfterShutdown);
		...
		[DllImport("advapi32")] public static extern int LookupAccountName(StringBuilder lpSystemName, StringBuilder lpAccountName, int Sid, int cbSid, StringBuilder ReferencedDomainName, int cbReferencedDomainName, int peUse);
		[DllImport("advapi32")] public static extern int LookupAccountSid(StringBuilder lpSystemName, IntPtr Sid, StringBuilder name, int cbName, StringBuilder ReferencedDomainName, int cbReferencedDomainName, int peUse);
		[DllImport("advapi32")] public static extern int LookupPrivilegeDisplayName(StringBuilder lpSystemName, StringBuilder lpName, StringBuilder lpDisplayName, int cbDisplayName, IntPtr  lpLanguageID);
		[DllImport("advapi32")] public static extern int LookupPrivilegeName(StringBuilder lpSystemName, ref LARGE_INTEGER lpLuid, StringBuilder lpName, int cbName);
		[DllImport("advapi32")] public static extern int LookupPrivilegeValue(StringBuilder lpSystemName, StringBuilder lpName, ref LARGE_INTEGER lpLuid);
		[DllImport("advapi32")] public static extern int MakeAbsoluteSD(ref SECURITY_DESCRIPTOR pSelfRelativeSecurityDescriptor, ref SECURITY_DESCRIPTOR pAbsoluteSecurityDescriptor, IntPtr  lpdwAbsoluteSecurityDescriptorSize, ref ACL pDacl, IntPtr  lpdwDaclSize, ref ACL pSacl, IntPtr  lpdwSaclSize, IntPtr pOwner, IntPtr  lpdwOwnerSize, IntPtr pPrimaryGroup, IntPtr  lpdwPrimaryGroupSize);
		[DllImport("advapi32")] public static extern int MakeSelfRelativeSD(ref SECURITY_DESCRIPTOR pAbsoluteSecurityDescriptor, ref SECURITY_DESCRIPTOR pSelfRelativeSecurityDescriptor, IntPtr  lpdwBufferLength);
		[DllImport("advapi32")] public static extern int NotifyBootConfigStatus(int BootAcceptable);
		[DllImport("advapi32")] public static extern int ObjectCloseAuditAlarm(StringBuilder SubsystemName, IntPtr HandleId, int GenerateOnClose);
		[DllImport("advapi32")] public static extern int ObjectPrivilegeAuditAlarm(StringBuilder SubsystemName, IntPtr HandleId, int ClientToken, int DesiredAccess, PRIVILEGE_SET Privileges, int AccessGranted);
		[DllImport("advapi32")] public static extern int OpenBackupEventLog(StringBuilder lpUNCServerName, StringBuilder lpFileName);
		[DllImport("advapi32")] public static extern int OpenEventLog(StringBuilder lpUNCServerName, StringBuilder lpSourceName);
		[DllImport("advapi32")] public static extern int OpenSCManager(StringBuilder lpMachineName, StringBuilder lpDatabaseName, int dwDesiredAccess);
		[DllImport("advapi32")] public static extern int OpenService(HANDLE hSCManager, StringBuilder lpServiceName, int dwDesiredAccess);
		...
		[DllImport("advapi32")] public static extern int PrivilegeCheck(int ClientToken, PRIVILEGE_SET RequiredPrivileges, IntPtr  pfResult);
		[DllImport("advapi32")] public static extern int PrivilegedServiceAuditAlarm(StringBuilder SubsystemName, StringBuilder ServiceName, int ClientToken, PRIVILEGE_SET Privileges, int AccessGranted);
		[DllImport("advapi32")] public static extern int QueryServiceConfig(HANDLE hService, ref QUERY_SERVICE_CONFIG lpServiceConfig, int cbBufSize, IntPtr  pcbBytesNeeded);
		[DllImport("advapi32")] public static extern int QueryServiceLockStatus(HANDLE hSCManager, ref QUERY_SERVICE_LOCK_STATUS lpLockStatus, int cbBufSize, IntPtr  pcbBytesNeeded);
		[DllImport("advapi32")] public static extern int QueryServiceObjectSecurity(HANDLE hService, int dwSecurityInformation, IntPtr lpSecurityDescriptor, int cbBufSize, IntPtr  pcbBytesNeeded);
		[DllImport("advapi32")] public static extern int QueryServiceStatus(HANDLE hService, ref SERVICE_STATUS lpServiceStatus);
		[DllImport("advapi32")] public static extern int ReadEventLog(HANDLE hEventLog, int dwReadFlags, int dwRecordOffset, ref EVENTLOGRECORD lpBuffer, int nNumberOfBytesToRead, IntPtr  pnBytesRead, IntPtr  pnMinNumberOfBytesNeeded);
		[DllImport("advapi32")] public static extern int RegCloseKey(HANDLE hKey);
		[DllImport("advapi32")] public static extern int RegConnectRegistry(StringBuilder lpMachineName, HANDLE hKey, IntPtr  phkResult);
		[DllImport("advapi32")] public static extern int RegCreateKey(HANDLE hKey, StringBuilder lpSubKey, IntPtr  phkResult);
		[DllImport("advapi32")] public static extern int RegCreateKeyEx(HANDLE hKey, StringBuilder lpSubKey, int Reserved, StringBuilder lpClass, int dwOptions, int samDesired, ref SECURITY_ATTRIBUTES lpSecurityAttributes, IntPtr  phkResult, IntPtr  lpdwDisposition);
		[DllImport("advapi32")] public static extern int RegDeleteKey(HANDLE hKey, StringBuilder lpSubKey);
		[DllImport("advapi32")] public static extern int RegDeleteValue(HANDLE hKey, StringBuilder lpValueName);
		[DllImport("advapi32")] public static extern int RegEnumKey(HANDLE hKey, int dwIndex, StringBuilder lpName, int cbName);
		[DllImport("advapi32")] public static extern int RegEnumKeyEx(HANDLE hKey, int dwIndex, StringBuilder lpName, IntPtr  lpcbName, IntPtr  lpReserved, StringBuilder lpClass, IntPtr  lpcbClass, ref FILETIME lpftLastWriteTime);
		[DllImport("advapi32")] public static extern int RegEnumValue(HANDLE hKey, int dwIndex, StringBuilder lpValueName, IntPtr  lpcbValueName, IntPtr  lpReserved, IntPtr  lpType, Byte lpData, IntPtr  lpcbData);
		[DllImport("advapi32")] public static extern int RegFlushKey(HANDLE hKey);
		[DllImport("advapi32")] public static extern int RegGetKeySecurity(HANDLE hKey, int SecurityInformation, ref SECURITY_DESCRIPTOR pSecurityDescriptor, IntPtr  lpcbSecurityDescriptor);
		[DllImport("advapi32")] public static extern int RegLoadKey(HANDLE hKey, StringBuilder lpSubKey, StringBuilder lpFile);
		...
		[DllImport("advapi32")] public static extern int RegOpenKey(HANDLE hKey, StringBuilder lpSubKey, IntPtr  phkResult);
		[DllImport("advapi32")] public static extern int RegOpenKeyEx(HANDLE hKey, StringBuilder lpSubKey, int ulOptions, int samDesired, IntPtr  phkResult);
		[DllImport("advapi32")] public static extern int RegQueryInfoKey(HANDLE hKey, StringBuilder lpClass, IntPtr  lpcbClass, IntPtr  lpReserved, IntPtr  lpcSubKeys, IntPtr  lpcbMaxSubKeyLen, IntPtr  lpcbMaxClassLen, IntPtr  lpcValues, IntPtr  lpcbMaxValueNameLen, IntPtr  lpcbMaxValueLen, IntPtr  lpcbSecurityDescriptor, ref FILETIME lpftLastWriteTime);
		[DllImport("advapi32")] public static extern int RegQueryValue(HANDLE hKey, StringBuilder lpSubKey, StringBuilder lpValue, IntPtr  lpcbValue);
		[DllImport("advapi32")] public static extern int RegQueryValueEx(HANDLE hKey, StringBuilder lpValueName, IntPtr  lpReserved, IntPtr  lpType, IntPtr lpData, IntPtr  lpcbData); 
		[DllImport("advapi32")] public static extern int RegReplaceKey(HANDLE hKey, StringBuilder lpSubKey, StringBuilder lpNewFile, StringBuilder lpOldFile);
		[DllImport("advapi32")] public static extern int RegRestoreKey(HANDLE hKey, StringBuilder lpFile, int dwFlags);
		[DllImport("advapi32")] public static extern int RegSaveKey(HANDLE hKey, StringBuilder lpFile, ref SECURITY_ATTRIBUTES lpSecurityAttributes);
		...
		[DllImport("advapi32")] public static extern int RegSetValue(HANDLE hKey, StringBuilder lpSubKey, int dwType, StringBuilder lpData, int cbData);
		[DllImport("advapi32")] public static extern int RegSetValueEx(HANDLE hKey, StringBuilder lpValueName, int Reserved, int dwType, IntPtr lpData, int cbData); 
		[DllImport("advapi32")] public static extern int RegUnLoadKey(HANDLE hKey, StringBuilder lpSubKey);
		[DllImport("advapi32")] public static extern int RegisterEventSource(StringBuilder lpUNCServerName, StringBuilder lpSourceName);
		[DllImport("advapi32")] public static extern int RegisterServiceCtrlHandler(StringBuilder lpServiceName, IntPtr  lpHandlerProc);
		[DllImport("advapi32")] public static extern int ReportEvent(HANDLE hEventLog, int wType, int wCategory, int dwEventID, IntPtr lpUserSid, int wNumStrings, int dwDataSize, IntPtr  lpStrings, IntPtr lpRawData);
		...
		[DllImport("advapi32")] public static extern int SetFileSecurity(StringBuilder lpFileName, int SecurityInformation, ref SECURITY_DESCRIPTOR pSecurityDescriptor);
		...
		[DllImport("advapi32")] public static extern int StartService(HANDLE hService, int dwNumServiceArgs, IntPtr  lpServiceArgVectors);
	...
	{
		[DllImport("version")] public static extern int GetFileVersionInfo(StringBuilder lptstrFilename, int dwHandle, int dwLen, IntPtr lpData);
		[DllImport("version")] public static extern int GetFileVersionInfoSize(StringBuilder lptstrFilename, IntPtr  lpdwHandle);
		[DllImport("version")] public static extern int VerFindFile(int uFlags, StringBuilder szFileName, StringBuilder szWinDir, StringBuilder szAppDir, StringBuilder szCurDir, IntPtr  lpuCurDirLen, StringBuilder szDestDir, IntPtr  lpuDestDirLen);
		[DllImport("version")] public static extern int VerInstallFile(int uFlags, StringBuilder szSrcFileName, StringBuilder szDestFileName, StringBuilder szSrcDir, StringBuilder szDestDir, StringBuilder szCurDir, StringBuilder szTmpFile, IntPtr  lpuTmpFileLen);
		[DllImport("version")] public static extern int VerQueryValue(IntPtr pBlock, StringBuilder lpSubBlock, IntPtr  lplpBuffer, IntPtr  puLen);
	}

	public abstract class Kernel
	{
		[DllImport("kernel32")] public static extern void OutputDebugString(StringBuilder lpszOutputString);
		...
		[DllImport("kernel32")] public static extern int BackupRead(HANDLE hFile, Byte lpBuffer, int nNumberOfBytesToRead, IntPtr  lpNumberOfBytesRead, int bAbort, int bProcessSecurity, IntPtr lpContext);
		[DllImport("kernel32")] public static extern int BackupSeek(HANDLE hFile, int dwLowBytesToSeek, int dwHighBytesToSeek, IntPtr  lpdwLowByteSeeked, IntPtr  lpdwHighByteSeeked, IntPtr  lpContext);
		[DllImport("kernel32")] public static extern int BackupWrite(HANDLE hFile, Byte lpBuffer, int nNumberOfBytesToWrite, IntPtr  lpNumberOfBytesWritten, int bAbort, int bProcessSecurity, IntPtr  lpContext);
		[DllImport("kernel32")] public static extern int Beep(int dwFreq, int dwDuration);
		[DllImport("kernel32")] public static extern int BeginUpdateResource(StringBuilder pFileName, int bDeleteExistingResources);
		[DllImport("kernel32")] public static extern int BuildCommDCB(StringBuilder lpDef, ref DCB lpDCB);
		[DllImport("kernel32")] public static extern int BuildCommDCBAndTimeouts(StringBuilder lpDef, ref DCB lpDCB, ref COMMTIMEOUTS lpCommTimeouts);
		[DllImport("kernel32")] public static extern int CallNamedPipe(StringBuilder lpNamedPipeName, IntPtr lpInBuffer, int nInBufferSize, IntPtr lpOutBuffer, int nOutBufferSize, IntPtr  lpBytesRead, int nTimeOut);
		[DllImport("kernel32")] public static extern int ClearCommBreak(int nCid);
		[DllImport("kernel32")] public static extern int ClearCommError(HANDLE hFile, IntPtr  lpErrors, ref COMSTAT lpStat);
		[DllImport("kernel32")] public static extern int CloseHandle(HANDLE hObject);
		[DllImport("kernel32")] public static extern int CommConfigDialog(StringBuilder lpszName, HWND hwnd, ref COMMCONFIG lpCC);
		[DllImport("kernel32")] public static extern int CompareFileTime(ref FILETIME lpFileTime1, ref FILETIME lpFileTime2);
		[DllImport("kernel32")] public static extern int CompareString(int Locale, int dwCmpFlags, StringBuilder lpString1, int cchCount1, StringBuilder lpString2, int cchCount2);
		...
		[DllImport("kernel32")] public static extern int CopyFile(StringBuilder lpExistingFileName, StringBuilder lpNewFileName, int bFailIfExists);
		...
		[DllImport("kernel32")] public static extern int CreateDirectory(StringBuilder lpPathName, ref SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("kernel32")] public static extern int CreateDirectoryEx(StringBuilder lpTemplateDirectory, StringBuilder lpNewDirectory, ref SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("kernel32")] public static extern int CreateEvent(ref SECURITY_ATTRIBUTES lpEventAttributes, int bManualReset, int bInitialState, StringBuilder lpName);
		[DllImport("kernel32")] public static extern int CreateFile(StringBuilder lpFileName, int dwDesiredAccess, int dwShareMode, ref SECURITY_ATTRIBUTES lpSecurityAttributes, int dwCreationDisposition, int dwFlagsAndAttributes, HANDLE hTemplateFile);
		[DllImport("kernel32")] public static extern int CreateFileMapping(HANDLE hFile, ref SECURITY_ATTRIBUTES lpFileMappigAttributes, int flProtect, int dwMaximumSizeHigh, int dwMaximumSizeLow, StringBuilder lpName);
		...
		[DllImport("kernel32")] public static extern int CreateMailslot(StringBuilder lpName, int nMaxMessageSize, int lReadTimeout, ref SECURITY_ATTRIBUTES lpSecurityAttributes);
		[DllImport("kernel32")] public static extern int CreateMutex(ref SECURITY_ATTRIBUTES lpMutexAttributes, int bInitialOwner, StringBuilder lpName);
		[DllImport("kernel32")] public static extern int CreateNamedPipe(StringBuilder lpName, int dwOpenMode, int dwPipeMode, int nMaxInstances, int nOutBufferSize, int nInBufferSize, int nDefaultTimeOut, ref SECURITY_ATTRIBUTES lpSecurityAttributes);
		...
		[DllImport("kernel32")] public static extern int CreateProcess(StringBuilder lpApplicationName, StringBuilder lpCommandLine, ref SECURITY_ATTRIBUTES lpProcessAttributes, ref SECURITY_ATTRIBUTES lpThreadAttributes, int bInheritHandles, int dwCreationFlags, IntPtr lpEnvironment, StringBuilder lpCurrentDriectory, ref STARTUPINFO lpStartupInfo, ref PROCESS_INFORMATION lpProcessInformation);
		[DllImport("kernel32")] public static extern int CreateRemoteThread(HANDLE hProcess, ref SECURITY_ATTRIBUTES lpThreadAttributes, int dwStackSize, IntPtr  lpStartAddress, IntPtr lpParameter, int dwCreationFlags, IntPtr  lpThreadId);
		[DllImport("kernel32")] public static extern int CreateSemaphore(ref SECURITY_ATTRIBUTES lpSemaphoreAttributes, int lInitialCount, int lMaximumCount, StringBuilder lpName);
		...
		[DllImport("kernel32")] public static extern int CreateThread(ref SECURITY_ATTRIBUTES lpThreadAttributes, int dwStackSize, IntPtr  lpStartAddress, IntPtr lpParameter, int dwCreationFlags, IntPtr  lpThreadId);
		[DllImport("kernel32")] public static extern int DebugActiveProcess(int dwProcessId);
		[DllImport("kernel32")] public static extern int DefineDosDevice(int dwFlags, StringBuilder lpDeviceName, StringBuilder lpTargetPath);
		[DllImport("kernel32")] public static extern int DeleteFile(StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int DeviceIoControl(HANDLE hDevice, int dwIoControlCode, IntPtr lpInBuffer, int nInBufferSize, IntPtr lpOutBuffer, int nOutBufferSize, IntPtr  lpBytesReturned, ref OVERLAPPED lpOverlapped);
		...
		[DllImport("kernel32")] public static extern int DuplicateHandle(HANDLE hSourceProcessHandle, HANDLE hSourceHandle, HANDLE hTargetProcessHandle, IntPtr  lpTargetHandle, int dwDesiredAccess, int bInheritHandle, int dwOptions);
		...
		[DllImport("kernel32")] public static extern int EnumResourceLanguages(HANDLE hModule, StringBuilder lpType, StringBuilder lpName, IntPtr  lpEnumFunc, int lParam);
		[DllImport("kernel32")] public static extern int EnumResourceNames(HANDLE hModule, StringBuilder lpType, IntPtr  lpEnumFunc, int lParam);
		[DllImport("kernel32")] public static extern int EnumResourceTypes(HANDLE hModule, IntPtr  lpEnumFunc, int lParam);
		...
		[DllImport("kernel32")] public static extern int ExpandEnvironmentStrings(StringBuilder lpSrc, StringBuilder lpDst, int nSize);
		[DllImport("kernel32")] public static extern int FileTimeToDosDateTime(ref FILETIME lpFileTime, IntPtr  lpFatDate, IntPtr  lpFatTime);
		...
		[DllImport("kernel32")] public static extern int FillConsoleOutputAttribute(HANDLE hConsoleOutput, int wAttribute, int nLength, COORD dwWriteCoord, IntPtr  lpNumberOfAttrsWritten);
		[DllImport("kernel32")] public static extern int FillConsoleOutputCharacter(HANDLE hConsoleOutput, Byte cCharacter, int nLength, COORD dwWriteCoord, IntPtr  lpNumberOfCharsWritten);
		...
		[DllImport("kernel32")] public static extern int FindFirstChangeNotification(StringBuilder lpPathName, int bWatchSubtree, int dwNotifyFilter);
		[DllImport("kernel32")] public static extern int FindFirstFile(StringBuilder lpFileName, WIN32_FIND_DATA lpFindFileData);
		...
		[DllImport("kernel32")] public static extern int FindResource(HANDLE hInstance, StringBuilder lpName, StringBuilder lpType);
		[DllImport("kernel32")] public static extern int FindResourceEx(HANDLE hModule, StringBuilder lpType, StringBuilder lpName, int wLanguage);
		...
		[DllImport("kernel32")] public static extern int FoldString(int dwMapFlags, StringBuilder lpSrcStr, int cchSrc, StringBuilder lpDestStr, int cchDest);
		[DllImport("kernel32")] public static extern int FormatMessage(int dwFlags, IntPtr lpSource, int dwMessageId, int dwLanguageId, StringBuilder lpBuffer, int nSize, int Arguments);
		[DllImport("kernel32")] public static extern int FreeConsole();
		[DllImport("kernel32")] public static extern int FreeEnvironmentStrings(StringBuilder lpsz);
		...
		[DllImport("kernel32")] public static extern int GetBinaryType(StringBuilder lpApplicationName, IntPtr  lpBinaryType);
		[DllImport("kernel32")] public static extern int GetCPInfo(int CodePage, ref CPINFO lpCPInfo);
		[DllImport("kernel32")] public static extern int GetCommConfig(HANDLE hCommDev, ref COMMCONFIG lpCC, IntPtr  lpdwSize);
		[DllImport("kernel32")] public static extern int GetCommMask(HANDLE hFile, IntPtr  lpEvtMask);
		[DllImport("kernel32")] public static extern int GetCommModemStatus(HANDLE hFile, IntPtr  lpModemStat);
		...
		[DllImport("kernel32")] public static extern int GetCompressedFileSize(StringBuilder lpFileName, IntPtr  lpFileSizeHigh);
		[DllImport("kernel32")] public static extern int GetComputerName(StringBuilder lpBuffer, int nSize);
		...
		[DllImport("kernel32")] public static extern int GetConsoleMode(HANDLE hConsoleHandle, IntPtr  lpMode);
		...
		[DllImport("kernel32")] public static extern int GetConsoleTitle(StringBuilder lpConsoleTitle, int nSize);
		[DllImport("kernel32")] public static extern int GetCurrencyFormat(int Locale, int dwFlags, StringBuilder lpValue, ref CURRENCYFMT lpFormat, StringBuilder lpCurrencyStr, int cchCurrency);
		[DllImport("kernel32")] public static extern int GetCurrentDirectory(int nBufferLength, StringBuilder lpBuffer);
		...
		[DllImport("kernel32")] public static extern int GetDateFormat(int Locale, int dwFlags, ref SYSTEMTIME lpDate, StringBuilder lpFormat, StringBuilder lpDateStr, int cchDate);
		[DllImport("kernel32")] public static extern int GetDefaultCommConfig(StringBuilder lpszName, ref COMMCONFIG lpCC, IntPtr  lpdwSize);
		[DllImport("kernel32")] public static extern int GetDiskFreeSpace(StringBuilder lpRootPathName, IntPtr  lpSectorsPerCluster, IntPtr  lpBytesPerSector, IntPtr  lpNumberOfFreeClusters, IntPtr  lpTotalNumberOfClusters);
		[DllImport("kernel32")] public static extern int GetDriveType(StringBuilder nDrive);
		[DllImport("kernel32")] public static extern int GetEnvironmentVariable(StringBuilder lpName, StringBuilder lpBuffer, int nSize);
		[DllImport("kernel32")] public static extern int GetExitCodeProcess(HANDLE hProcess, IntPtr  lpExitCode);
		[DllImport("kernel32")] public static extern int GetExitCodeThread(HANDLE hThread, IntPtr  lpExitCode);
		[DllImport("kernel32")] public static extern int GetFileAttributes(StringBuilder lpFileName);
		...
		[DllImport("kernel32")] public static extern int GetFileSize(HANDLE hFile, IntPtr  lpFileSizeHigh);
		...
		[DllImport("kernel32")] public static extern int GetFullPathName(StringBuilder lpFileName, int nBufferLength, StringBuilder lpBuffer, StringBuilder lpFilePart);
		[DllImport("kernel32")] public static extern int GetHandleInformation(HANDLE hObject, IntPtr  lpdwFlags);
		[DllImport("kernel32")] public static extern int GetLastError();
		[DllImport("kernel32")] public static extern int GetLocaleInfo(int Locale, int LCType, StringBuilder lpLCData, int cchData);
		...
		[DllImport("kernel32")] public static extern int GetMailslotInfo(HANDLE hMailslot, IntPtr  lpMaxMessageSize, IntPtr  lpNextSize, IntPtr  lpMessageCount, IntPtr  lpReadTimeout);
		[DllImport("kernel32")] public static extern int GetModuleFileName(HANDLE hModule, StringBuilder lpFileName, int nSize);
		[DllImport("kernel32")] public static extern int GetModuleHandle(StringBuilder lpModuleName);
		[DllImport("kernel32")] public static extern int GetNamedPipeHandleState(HANDLE hNamedPipe, IntPtr  lpState, IntPtr  lpCurInstances, IntPtr  lpMaxCollectionCount, IntPtr  lpCollectDataTimeout, StringBuilder lpUserName, int nMaxUserNameSize);
		[DllImport("kernel32")] public static extern int GetNamedPipeInfo(HANDLE hNamedPipe, IntPtr  lpFlags, IntPtr  lpOutBufferSize, IntPtr  lpInBufferSize, IntPtr  lpMaxInstances);
		[DllImport("kernel32")] public static extern int GetNumberFormat(int Locale, int dwFlags, StringBuilder lpValue, ref NUMBERFMT lpFormat, StringBuilder lpNumberStr, int cchNumber);
		[DllImport("kernel32")] public static extern int GetNumberOfConsoleInputEvents(HANDLE hConsoleInput, IntPtr  lpNumberOfEvents);
		...
		[DllImport("kernel32")] public static extern int GetOverlappedResult(HANDLE hFile, ref OVERLAPPED lpOverlapped, IntPtr  lpNumberOfBytesTransferred, int bWait);
		[DllImport("kernel32")] public static extern int GetPriorityClass(HANDLE hProcess);
		[DllImport("kernel32")] public static extern int GetPrivateProfileInt(StringBuilder lpApplicationName, StringBuilder lpKeyName, int nDefault, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int GetPrivateProfileSection(StringBuilder lpAppName, StringBuilder lpReturnedString, int nSize, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int GetPrivateProfileString(StringBuilder lpApplicationName, IntPtr lpKeyName, StringBuilder lpDefault, StringBuilder lpReturnedString, int nSize, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int GetPrivateProfileString(StringBuilder lpApplicationName, StringBuilder lpKeyName, StringBuilder lpDefault, StringBuilder lpReturnedString, int nSize, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int GetProcessAffinityMask(HANDLE hProcess, IntPtr  lpProcessAffinityMask, int SystemAffinityMask);
		...
		[DllImport("kernel32")] public static extern int GetProcessShutdownParameters(int lpdwLevel, IntPtr  lpdwFlags);
		...
		[DllImport("kernel32")] public static extern int GetProcessWorkingSetSize(HANDLE hProcess, IntPtr  lpMinimumWorkingSetSize, IntPtr  lpMaximumWorkingSetSize);
		[DllImport("kernel32")] public static extern int GetProfileInt(StringBuilder lpAppName, StringBuilder lpKeyName, int nDefault);
		[DllImport("kernel32")] public static extern int GetProfileSection(StringBuilder lpAppName, StringBuilder lpReturnedString, int nSize);
		[DllImport("kernel32")] public static extern int GetProfileString(StringBuilder lpAppName, StringBuilder lpKeyName, StringBuilder lpDefault, StringBuilder lpReturnedString, int nSize);
		[DllImport("kernel32")] public static extern int GetQueuedCompletionStatus(int CompletionPort, IntPtr  lpNumberOfBytesTransferred, IntPtr  lpCompletionKey, IntPtr  lpOverlapped, int dwMilliseconds);
		[DllImport("kernel32")] public static extern int GetShortPathName(StringBuilder lpszLongPath, StringBuilder lpszShortPath, int cchBuffer);
		[DllImport("kernel32")] public static extern int GetStdHandle(int nStdHandle);
		[DllImport("kernel32")] public static extern int GetStringTypeA(int lcid, int dwInfoType, StringBuilder lpSrcStr, int cchSrc, IntPtr  lpCharType);
		...
		[DllImport("kernel32")] public static extern int GetSystemTimeAdjustment(int lpTimeAdjustment, IntPtr  lpTimeIncrement, IntPtr  lpTimeAdjustmentDisabled);
		[DllImport("kernel32")] public static extern int GetTapeParameters(HANDLE hDevice, int dwOperation, IntPtr  lpdwSize, IntPtr lpTapeInformation);
		[DllImport("kernel32")] public static extern int GetTapePosition(HANDLE hDevice, int dwPositionType, IntPtr  lpdwPartition, IntPtr  lpdwOffsetLow, IntPtr  lpdwOffsetHigh);
		[DllImport("kernel32")] public static extern int GetTapeStatus(HANDLE hDevice);
		[DllImport("kernel32")] public static extern int GetTempFileName(StringBuilder lpszPath, StringBuilder lpPrefixString, int wUnique, StringBuilder lpTempFileName);
		...
		[DllImport("kernel32")] public static extern int GetTimeFormat(int Locale, int dwFlags, ref SYSTEMTIME lpTime, StringBuilder lpFormat, StringBuilder lpTimeStr, int cchTime);
		...
		[DllImport("kernel32")] public static extern int GetVolumeInformation(StringBuilder lpRootPathName, StringBuilder lpVolumeNameBuffer, int nVolumeNameSize, IntPtr  lpVolumeSerialNumber, IntPtr  lpMaximumComponentLength, IntPtr  lpFileSystemFlags, StringBuilder lpFileSystemNameBuffer, int nFileSystemNameSize);
		...
		[DllImport("kernel32")] public static extern int GlobalGetAtomName(short nAtom, StringBuilder lpBuffer, int nSize);
		...
		[DllImport("kernel32")] public static extern int IsBadStringPtr(StringBuilder lpsz, int ucchMax);
		...
		[DllImport("kernel32")] public static extern int LCMapString(int Locale, int dwMapFlags, StringBuilder lpSrcStr, int cchSrc, StringBuilder lpDestStr, int cchDest);
		[DllImport("kernel32")] public static extern int LoadLibrary(StringBuilder lpLibFileName);
		[DllImport("kernel32")] public static extern int LoadLibraryEx(StringBuilder lpLibFileName, HANDLE hFile, int dwFlags);
		[DllImport("kernel32")] public static extern int LoadModule(StringBuilder lpModuleName, IntPtr lpParameterBlock);
		...
		[DllImport("kernel32")] public static extern int MoveFile(StringBuilder lpExistingFileName, StringBuilder lpNewFileName);
		[DllImport("kernel32")] public static extern int MoveFileEx(StringBuilder lpExistingFileName, StringBuilder lpNewFileName, int dwFlags);
		[DllImport("kernel32")] public static extern int MulDiv(int nNumber, int nNumerator, int nDenominator);
		[DllImport("kernel32")] public static extern int MultiByteToWideChar(int CodePage, int dwFlags, StringBuilder lpMultiByteStr, int cchMultiByte, StringBuilder lpWideCharStr, int cchWideChar);
		[DllImport("kernel32")] public static extern int OpenEvent(int dwDesiredAccess, int bInheritHandle, StringBuilder lpName);
		[DllImport("kernel32")] public static extern int OpenFile(StringBuilder lpFileName, ref OFSTRUCT lpReOpenBuff, int wStyle);
		[DllImport("kernel32")] public static extern int OpenFileMapping(int dwDesiredAccess, int bInheritHandle, StringBuilder lpName);
		[DllImport("kernel32")] public static extern int OpenMutex(int dwDesiredAccess, int bInheritHandle, StringBuilder lpName);
		[DllImport("kernel32")] public static extern int OpenProcess(int dwDesiredAccess, int bInheritHandle, int dwProcessId);
		[DllImport("kernel32")] public static extern int OpenSemaphore(int dwDesiredAccess, int bInheritHandle, StringBuilder lpName);
		[DllImport("kernel32")] public static extern int PeekNamedPipe(HANDLE hNamedPipe, IntPtr lpBuffer, int nBufferSize, IntPtr  lpBytesRead, IntPtr  lpTotalBytesAvail, IntPtr  lpBytesLeftThisMessage);
		...
		[DllImport("kernel32")] public static extern int QueryDosDevice(StringBuilder lpDeviceName, StringBuilder lpTargetPath, int ucchMax);
		...
		[DllImport("kernel32")] public static extern int ReadConsole(HANDLE hConsoleInput, IntPtr lpBuffer, int nNumberOfCharsToRead, IntPtr  lpNumberOfCharsRead, IntPtr lpReserved);
		...
		[DllImport("kernel32")] public static extern int ReadConsoleOutputAttribute(HANDLE hConsoleOutput, IntPtr  lpAttribute, int nLength, COORD dwReadCoord, IntPtr  lpNumberOfAttrsRead);
		[DllImport("kernel32")] public static extern int ReadConsoleOutputCharacter(HANDLE hConsoleOutput, StringBuilder lpCharacter, int nLength, COORD dwReadCoord, IntPtr  lpNumberOfCharsRead);
		[DllImport("kernel32")] public static extern int ReadFile(HANDLE hFile, IntPtr lpBuffer, int nNumberOfBytesToRead, IntPtr  lpNumberOfBytesRead, ref OVERLAPPED lpOverlapped);
		[DllImport("kernel32")] public static extern int ReadFileEx(HANDLE hFile, IntPtr lpBuffer, int nNumberOfBytesToRead, ref OVERLAPPED lpOverlapped, IntPtr  lpCompletionRoutine);
		[DllImport("kernel32")] public static extern int ReadProcessMemory(HANDLE hProcess, IntPtr lpBaseAddress, IntPtr lpBuffer, int nSize, IntPtr  lpNumberOfBytesWritten);
		[DllImport("kernel32")] public static extern int ReleaseMutex(HANDLE hMutex);
		[DllImport("kernel32")] public static extern int ReleaseSemaphore(HANDLE hSemaphore, int lReleaseCount, IntPtr  lpPreviousCount);
		[DllImport("kernel32")] public static extern int RemoveDirectory(StringBuilder lpPathName);
		...
		[DllImport("kernel32")] public static extern int SearchPath(StringBuilder lpPath, StringBuilder lpFileName, StringBuilder lpExtension, int nBufferLength, StringBuilder lpBuffer, StringBuilder lpFilePart);
		...
		[DllImport("kernel32")] public static extern int SetComputerName(StringBuilder lpComputerName);
		...
		[DllImport("kernel32")] public static extern int SetConsoleTitle(StringBuilder lpConsoleTitle);
		...
		[DllImport("kernel32")] public static extern int SetCurrentDirectory(StringBuilder lpPathName);
		[DllImport("kernel32")] public static extern int SetDefaultCommConfig(StringBuilder lpszName, ref COMMCONFIG lpCC, int dwSize);
		[DllImport("kernel32")] public static extern int SetEndOfFile(HANDLE hFile);
		[DllImport("kernel32")] public static extern int SetEnvironmentVariable(StringBuilder lpName, StringBuilder lpValue);
		...
		[DllImport("kernel32")] public static extern int SetFileAttributes(StringBuilder lpFileName, int dwFileAttributes);
		[DllImport("kernel32")] public static extern int SetFilePointer(HANDLE hFile, int lDistanceToMove, IntPtr  lpDistanceToMoveHigh, int dwMoveMethod);
		...
		[DllImport("kernel32")] public static extern int SetLocaleInfo(int Locale, int LCType, StringBuilder lpLCData);
		[DllImport("kernel32")] public static extern int SetMailslotInfo(HANDLE hMailslot, int lReadTimeout);
		[DllImport("kernel32")] public static extern int SetNamedPipeHandleState(HANDLE hNamedPipe, IntPtr  lpMode, IntPtr  lpMaxCollectionCount, IntPtr  lpCollectDataTimeout);
		...
		[DllImport("kernel32")] public static extern int SetVolumeLabel(StringBuilder lpRootPathName, StringBuilder lpVolumeName);
		...
		[DllImport("kernel32")] public static extern int TransactNamedPipe(HANDLE hNamedPipe, IntPtr lpInBuffer, int nInBufferSize, IntPtr lpOutBuffer, int nOutBufferSize, IntPtr  lpBytesRead, ref OVERLAPPED lpOverlapped);
		...
		[DllImport("kernel32")] public static extern int UpdateResource(HANDLE hUpdate, StringBuilder lpType, StringBuilder lpName, int wLanguage, IntPtr lpData, int cbData);
		[DllImport("kernel32")] public static extern int VerLanguageName(int wLang, StringBuilder szLang, int nSize);
		...
		[DllImport("kernel32")] public static extern int VirtualProtect(IntPtr lpAddress, int dwSize, int flNewProtect, IntPtr  lpflOldProtect);
		[DllImport("kernel32")] public static extern int VirtualProtectEx(HANDLE hProcess, IntPtr lpAddress, int dwSize, int flNewProtect, IntPtr  lpflOldProtect);
		...
		[DllImport("kernel32")] public static extern int WaitCommEvent(HANDLE hFile, IntPtr  lpEvtMask, ref OVERLAPPED lpOverlapped);
		[DllImport("kernel32")] public static extern int WaitForMultipleObjects(int nCount, IntPtr  lpHandles, int bWaitAll, int dwMilliseconds);
		[DllImport("kernel32")] public static extern int WaitForMultipleObjectsEx(int nCount, IntPtr  lpHandles, int bWaitAll, int dwMilliseconds, int bAlertable);
		...
		[DllImport("kernel32")] public static extern int WaitNamedPipe(StringBuilder lpNamedPipeName, int nTimeOut);
		[DllImport("kernel32")] public static extern int WideCharToMultiByte(int CodePage, int dwFlags, StringBuilder lpWideCharStr, int cchWideChar, StringBuilder lpMultiByteStr, int cchMultiByte, StringBuilder lpDefaultChar, IntPtr  lpUsedDefaultChar);
		[DllImport("kernel32")] public static extern int WinExec(StringBuilder lpCmdLine, int nCmdShow);
		[DllImport("kernel32")] public static extern int WriteConsole(HANDLE hConsoleOutput, IntPtr lpBuffer, int nNumberOfCharsToWrite, IntPtr  lpNumberOfCharsWritten, IntPtr lpReserved);
		...
		[DllImport("kernel32")] public static extern int WriteConsoleOutputAttribute(HANDLE hConsoleOutput, short lpAttribute, int nLength, COORD dwWriteCoord, IntPtr  lpNumberOfAttrsWritten);
		[DllImport("kernel32")] public static extern int WriteConsoleOutputCharacter(HANDLE hConsoleOutput, StringBuilder lpCharacter, int nLength, COORD dwWriteCoord, IntPtr  lpNumberOfCharsWritten);
		[DllImport("kernel32")] public static extern int WriteFile(HANDLE hFile, IntPtr lpBuffer, int nNumberOfBytesToWrite, IntPtr  lpNumberOfBytesWritten, ref OVERLAPPED lpOverlapped);
		[DllImport("kernel32")] public static extern int WriteFileEx(HANDLE hFile, IntPtr lpBuffer, int nNumberOfBytesToWrite, ref OVERLAPPED lpOverlapped, IntPtr  lpCompletionRoutine);
		[DllImport("kernel32")] public static extern int WritePrivateProfileSection(StringBuilder lpAppName, StringBuilder lpString, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int WritePrivateProfileString(StringBuilder lpApplicationName, IntPtr lpKeyName, IntPtr lpString, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int WritePrivateProfileString(StringBuilder lpApplicationName, StringBuilder lpKeyName, IntPtr lpString, StringBuilder lpFileName);
		[DllImport("kernel32")] public static extern int WriteProcessMemory(HANDLE hProcess, IntPtr lpBaseAddress, IntPtr lpBuffer, int nSize, IntPtr  lpNumberOfBytesWritten);
		[DllImport("kernel32")] public static extern int WriteProfileSection(StringBuilder lpAppName, StringBuilder lpString);
		[DllImport("kernel32")] public static extern int WriteProfileString(StringBuilder lpszSection, StringBuilder lpszKeyName, StringBuilder lpszString);
		...
		[DllImport("kernel32")] public static extern int hwrite(HANDLE hFile, StringBuilder lpBuffer, int lBytes);
		[DllImport("kernel32")] public static extern int lclose(HANDLE hFile);
		[DllImport("kernel32")] public static extern int lcreat(StringBuilder lpPathName, int iAttribute);
		[DllImport("kernel32")] public static extern int llseek(HANDLE hFile, int lOffset, int iOrigin);
		[DllImport("kernel32")] public static extern int lopen(StringBuilder lpPathName, int iReadWrite);
		[DllImport("kernel32")] public static extern int lread(HANDLE hFile, IntPtr lpBuffer, int wBytes);
		[DllImport("kernel32")] public static extern int lstrcat(StringBuilder lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcmp(StringBuilder lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcmpi(StringBuilder lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcpy(StringBuilder lpString1, StringBuilder lpString2);
		[DllImport("kernel32")] public static extern int lstrcpyn(StringBuilder lpString1, StringBuilder lpString2, int iMaxLength);
		[DllImport("kernel32")] public static extern int lstrlen(StringBuilder lpString);
		[DllImport("kernel32")] public static extern int lwrite(HANDLE hFile, StringBuilder lpBuffer, int wBytes);
		...
		[DllImport("kernel32")] public static extern short GlobalAddAtom(StringBuilder lpString);
		[DllImport("kernel32")] public static extern short GlobalDeleteAtom(short nAtom);
		[DllImport("kernel32")] public static extern short GlobalFindAtom(StringBuilder lpString);
		...
		[DllImport("kernel32")] public static extern void FatalAppExit(int uAction, StringBuilder lpMessageText);
		...
		[DllImport("kernel32")] public static extern void RaiseException(int dwExceptionCode, int dwExceptionFlags, int nNumberOfArguments, IntPtr  lpArguments);
		...
		[DllImport("kernel32")] public static extern int GetProcAddress(HANDLE hModule, StringBuilder lpProcName);
