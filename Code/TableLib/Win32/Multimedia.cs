...
namespace Win32
{
	...
	public abstract class LZ
	{
		...
		[DllImport("lz32")] public static extern int GetExpandedName(StringBuilder lpszSource, StringBuilder lpszBuffer);
		...
		[DllImport("lz32")] public static extern int LZOpenFile(StringBuilder lpszFile, ref OFSTRUCT lpOf, int style);
		[DllImport("lz32")] public static extern int LZRead(HANDLE hfFile, StringBuilder lpvBuf, int cbread);
	...
	public abstract class WinMM
	{
		...
		[DllImport("winmm")] public static extern int OpenDriver(StringBuilder szDriverName, StringBuilder szSectionName, int lParam2);
		[DllImport("winmm")] public static extern int PlaySound(StringBuilder lpszName, HANDLE hModule, int dwFlags);
		...
		[DllImport("winmm")] public static extern int mciExecute(StringBuilder lpstrCommand);
		[DllImport("winmm")] public static extern int mciGetCreatorTask(int wDeviceID);
		[DllImport("winmm")] public static extern int mciGetDeviceID(StringBuilder lpstrName);
		[DllImport("winmm")] public static extern int mciGetDeviceIDFromElementID(int dwElementID, StringBuilder lpstrType);
		[DllImport("winmm")] public static extern int mciGetErrorString(int dwError, StringBuilder lpstrBuffer, int uLength);
		[DllImport("winmm")] public static extern int mciSendCommand(int wDeviceID, int uMessage, int dwParam1, IntPtr dwParam2);
		[DllImport("winmm")] public static extern int mciSendString(StringBuilder lpstrCommand, StringBuilder lpstrReturnString, int uReturnLength, HWND hwndCallback);
		...
		[DllImport("winmm")] public static extern int mmioOpen(StringBuilder szFileName, ref MMIOINFO lpmmioinfo, int dwOpenFlags);
		[DllImport("winmm")] public static extern int mmioRead(HANDLE hmmio, StringBuilder pch, int cch);
		[DllImport("winmm")] public static extern int mmioRename(StringBuilder szFileName, StringBuilder SzNewFileName, ref MMIOINFO lpmmioinfo, int dwRenameFlags);
		...
		[DllImport("winmm")] public static extern int mmioSetBuffer(HANDLE hmmio, StringBuilder pchBuffer, int cchBuffer, int uFlags);
		[DllImport("winmm")] public static extern int mmioSetInfo(HANDLE hmmio, ref MMIOINFO lpmmioinfo, int uFlags);
		[DllImport("winmm")] public static extern int mmioStringToFOURCC(StringBuilder sz, int uFlags);
		[DllImport("winmm")] public static extern int mmioWrite(HANDLE hmmio, StringBuilder pch, int cch);
		[DllImport("winmm")] public static extern int mmsystemGetVersion();
		[DllImport("winmm")] public static extern int sndPlaySound(StringBuilder lpszSoundName, int uFlags);
